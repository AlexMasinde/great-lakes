...
import LakeData from "@/components/LakeData";
import LakeProjects from "@/components/LakeProjects";
  ...
  return (
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <motion.div
              key="data"
              initial={{opacity: 0}}
              animate={{opacity: selectedTab === "data" ? 1 : 0}}
              transition={{duration: 0.3}}
              style={{display: selectedTab === "data" ? "block" : "none"}}
          >
              <LakeData lakeName={name}/>
          </motion.div>
          <motion.div
              key="projects"
              initial={{opacity: 0}}
              animate={{opacity: selectedTab === "projects" ? 1 : 0}}
              transition={{duration: 0.3}}
              style={{display: selectedTab === "projects" ? "block" : "none"}}
          >
              <LakeProjects lakeName={name}/>
          </motion.div>
          <motion.div
              key="gallery"
              initial={{opacity: 0}}
